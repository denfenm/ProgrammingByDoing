...
public class doWhileSwimming
{
    public static void main( String[] args ) throws Exception
    {
        ...
        } //when 78 is entered, total swim time is 0min. he checks temp first and doesnt just dive in. pre test loop
    ...
    }//when 78 is entered, total swim time is 1min. goofus dived right in,post test loop=will still execute even if doesnt meet condition
}