...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		System.out.println(b());    // returns the word to be displayedk
		boolean doit = true;   // pass it 'true' and it will display a word beginning with C
		d();  // displays a word beginning with D
		e(1); // pass it the number of letters to display (9)
		f("Fence");     // displays the word you pass it beginning with "F"
	...
	j(3);    // returns a different word depending on what you pass it (1-3)
		...
		n("nice");    // displays the word you pass it beginning with "N"
	...
	s(1);    // pass it the number of letters to display (6)
		t("Tit");    // displays the word you pass it beginning with "T"
		...
		System.out.println(z(true,true));    // returns a different word depending on which two boolean values you pass it
		System.out.println();
	}
